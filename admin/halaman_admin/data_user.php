...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="data_user.php">Data User</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container table-container">
        ...
        <table class="table table-striped">
            ...
            <tbody> <!-- Mulai elemen tbody di sini -->
                ...
                if (isset($_POST['keyword'])) {
                    ...
                    $startIndex = 0; // Reset startIndex saat melakukan pencarian
        ...
        <a class="btn btn-secondary back-button" href="data_user.php?page=<?php echo $currentPage; ?>">Kembali</a>
    </div>
